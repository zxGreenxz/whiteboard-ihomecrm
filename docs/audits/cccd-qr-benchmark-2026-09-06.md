...
**Trạng thái phát hành:** chưa push/promote tại lần ghi bằng chứng này; rà soát và gate cục bộ đã hoàn tất, CI của đúng commit và xác minh deployment là bước tiếp theo. Clipboard hệ điều hành Windows, webcam thật, Android Chrome và iPhone Safari chưa được kiểm vật lý. Tốc độ tải model lần đầu trên mạng công cộng và bộ nhớ thiết bị di động chưa có số đo. Các phần bên dưới giữ số đo lịch sử và phương pháp để đối chiếu.
