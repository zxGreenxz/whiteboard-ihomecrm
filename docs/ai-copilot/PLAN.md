...
> **Lifecycle:** thiết kế v2.1 đã được triển khai các phase chat/tool/UI-control; đọc [README current](README.md) để biết trạng thái đang chạy. Các đoạn “sẽ làm” bên dưới là rationale hoặc backlog, không phải cam kết rằng tính năng còn thiếu hôm nay.
