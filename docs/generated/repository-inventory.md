...
- **472** file test, **158** file đọc file bằng fs (321 lời gọi)
- **169** lời gọi **KHÔNG phân loại được** — đường dẫn dựng lúc chạy.
...
|---|---|---|
| sql | 55 | Đọc migration/SQL. Thường hợp lệ: SQL không import được, và nội dung CHÍNH LÀ hợp đồng. |
