...
- **433** file test, **141** file đọc file bằng fs (296 lời gọi)
...
|---|---|---|
| sql | 49 | Đọc migration/SQL. Thường hợp lệ: SQL không import được, và nội dung CHÍNH LÀ hợp đồng. |
| ma-nguon | 26 | Đọc mã nguồn rồi khẳng định trên văn bản — thứ cần chuyển sang data-driven. |
| manifest | 17 | Đọc manifest/cấu hình. Hợp lệ: đây đúng là dữ liệu, và lệch manifest là thứ cần canh. |
| tai-lieu | 3 | Đọc tài liệu/asset. |
| powershell | 3 | Đọc script PowerShell. Hợp lệ vì lý do như SQL. |

## 26 file đọc MÃ NGUỒN
