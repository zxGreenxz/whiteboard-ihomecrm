...
- **652** file test, **203** file đọc file bằng fs (430 lời gọi)
- **207** lời gọi **KHÔNG phân loại được** — đường dẫn dựng lúc chạy.
...
|---|---|---|
| sql | 65 | Đọc migration/SQL. Thường hợp lệ: SQL không import được, và nội dung CHÍNH LÀ hợp đồng. |
