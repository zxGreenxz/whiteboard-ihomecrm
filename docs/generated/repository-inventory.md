...
- **542** file test, **181** file đọc file bằng fs (371 lời gọi)
- **189** lời gọi **KHÔNG phân loại được** — đường dẫn dựng lúc chạy.
...
| manifest | 21 | Đọc manifest/cấu hình. Hợp lệ: đây đúng là dữ liệu, và lệch manifest là thứ cần canh. |
