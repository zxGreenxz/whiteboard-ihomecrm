...
- **482** file test, **164** file đọc file bằng fs (335 lời gọi)
...
|---|---|---|
| sql | 60 | Đọc migration/SQL. Thường hợp lệ: SQL không import được, và nội dung CHÍNH LÀ hợp đồng. |
| ma-nguon | 32 | Đọc mã nguồn rồi khẳng định trên văn bản — thứ cần chuyển sang data-driven. |
