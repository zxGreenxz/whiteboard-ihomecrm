...
- **593** file test, **191** file đọc file bằng fs (393 lời gọi)
- **194** lời gọi **KHÔNG phân loại được** — đường dẫn dựng lúc chạy.
...
| manifest | 26 | Đọc manifest/cấu hình. Hợp lệ: đây đúng là dữ liệu, và lệch manifest là thứ cần canh. |
