...
- **561** file test, **186** file đọc file bằng fs (463 lời gọi)
- **246** lời gọi **KHÔNG phân loại được** — đường dẫn dựng lúc chạy.
...
|---|---|---|
| sql | 52 | Đọc migration/SQL. Thường hợp lệ: SQL không import được, và nội dung CHÍNH LÀ hợp đồng. |
| ma-nguon | 42 | Đọc mã nguồn rồi khẳng định trên văn bản — thứ cần chuyển sang data-driven. |
...
- `scripts/__tests__/network-center-rollout.test.mjs`
