...
- Supabase PostgreSQL 17.6: 823 migration, ~1000 hàm SECURITY DEFINER, RLS trên mọi bảng public
...
- **Legacy history KHÔNG replay được** — đừng tin `supabase db push` hay `supabase start`:
  823 file có 38 nhóm trùng version (81 file) + bộ legacy `001_`–`033_` còn collision nội bộ
