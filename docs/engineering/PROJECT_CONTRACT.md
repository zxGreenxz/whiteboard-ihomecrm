...
- Supabase PostgreSQL 17.6: 633 migration, ~1000 hàm SECURITY DEFINER, RLS trên mọi bảng public
...
- **Legacy history KHÔNG replay được** — đừng tin `supabase db push` hay `supabase start`:
  633 file có 36 nhóm trùng version (77 file) + bộ legacy `001_`–`033_` còn collision nội bộ
