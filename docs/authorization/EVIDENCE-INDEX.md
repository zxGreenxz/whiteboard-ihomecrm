...
- **Kết quả (fresh, exact-source):** submit e2e **7/7**, T1b payment **7/7**, T5 invoice/reversal **6/6**, approval v2 **11/11** (thêm non-candidate-deny + self-approve-permission), transition **5/5** (allowlist probe 7 cột). **Tổng bộ prepared: 132 assertion / 16 suite PASS (121 SQL + 11 JS); check-definer-acl 100=baseline.**
