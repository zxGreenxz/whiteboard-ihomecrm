...
Trang **Cài đặt chung** là bảng điều khiển hành vi mặc định của toàn hệ thống: thông tin cơ bản của đơn vị (logo), quy tắc cho hợp đồng, cách tính và duyệt hoá đơn, cách duyệt phiếu thu chi, và các thông báo tự động. Bạn gom mọi tuỳ chọn này vào **5 thẻ (tab)** trên cùng một màn hình, gạt công tắc hoặc chọn giá trị là hệ thống ghi nhớ ngay — không có nút "Lưu" riêng.

Điểm cần nắm trước tiên: đây là cấu hình **theo từng tài khoản chủ** (per-owner). Bạn đặt một lần, hệ thống dùng ở khắp nơi. Vì vậy hãy cân nhắc kỹ những công tắc ảnh hưởng tới dòng tiền (ví dụ tự động duyệt thu chi) và những cấu hình liên quan tới nhân viên.
...
**Bước 5**: Mở thẻ **Thu chi** (tiêu đề *Cấu hình thu chi*). Thẻ này chỉ có một công tắc: **Tự động duyệt thu chi**. Bật lên nghĩa là phiếu thu/phiếu chi được duyệt ngay khi tạo, bỏ qua bước xác nhận thủ công.
...
| Thẻ **Thu chi** | Bật/tắt tự động duyệt phiếu thu, phiếu chi. |
...
| Muốn kiểm soát lại từng phiếu sau khi đã bật tự động duyệt | Tắt **Tự động duyệt thu chi**; các phiếu lập sau đó sẽ ở trạng thái chờ duyệt để bạn xác nhận. |
...
4. Để ý thẻ **Thu chi** chỉ có duy nhất công tắc **Tự động duyệt thu chi** — tuỳ chọn ảnh hưởng tới cách phiếu được duyệt.
...
- [Thu chi](/03-quan-ly-van-hanh/thu-chi/) — nơi công tắc **Tự động duyệt thu chi** phát huy tác dụng khi lập phiếu.
