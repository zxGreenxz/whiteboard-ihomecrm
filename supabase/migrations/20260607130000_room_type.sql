-- =============================================
-- Migration: Thêm "Loại phòng" (rooms.room_type) — vd "Gác, Cửa kính", "Ban công",
-- "Studio", "Cửa sổ hành lang"... (cột LOẠI PHÒNG trong bảng phòng trống).
-- Trước đây trang public suy "Loại phòng" từ max_occupants ("Tối đa N người") — sai.
-- CREATE OR REPLACE get_public_available_rooms để trả thêm rm.room_type (qua to_jsonb).
-- =============================================
