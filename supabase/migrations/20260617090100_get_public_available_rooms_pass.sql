-- =============================================================================
-- get_public_available_rooms: hỗ trợ "phòng khách nhờ sale / pass phòng"
-- =============================================================================
-- BASE: 20260611120000 (bản MỚI NHẤT — dùng area_ids[] từ area_buildings sau khi
-- buildings.area_id đã DROP). Bổ sung:
--   1. LEFT JOIN room_pass_listings (active) của owner vào CTE rms.
--   2. status_public thêm nhánh 'pass' ĐẶT TRƯỚC mọi nhánh khác (phòng đang có HĐ
--      vẫn ra 'pass'); trả kèm pass_contact_name/phone, pass_sale_policy, pass_price.
--   3. bld_ids gồm cả 'pass' → tòa chỉ có phòng pass vẫn lên kênh.
-- KHÔNG lộ user_id/contract_id/customers; chỉ trả 4 field pass nhập tay (opt-in).
-- =============================================================================
