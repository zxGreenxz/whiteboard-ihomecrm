...
BEGIN
 ...
 FOR r IN SELECT * FROM (VALUES
  ...
  ('app_private.resolve_finance_actor_v2()','b95ceecadba70fe6c24304ce8e5a7e4f','b95ceecadba70fe6c24304ce8e5a7e4f','postgres',ARRAY['PUBLIC','postgres']::text[],true),
  ('app_private.resolve_finance_actor_v2(uuid)','840896c6babad119cd41462d8804f4a8','840896c6babad119cd41462d8804f4a8','postgres',ARRAY['PUBLIC','postgres']::text[],true),
  ('approve_and_post_income_expense_v2(jsonb)','a6f22730d4c8eb574c62ab2d5abadb67','a6f22730d4c8eb574c62ab2d5abadb67','postgres',ARRAY['PUBLIC','anon','authenticated','postgres','service_role']::text[],true),
  ...
  ('post_approved_income_expense_v2(jsonb)','e52de7af90d025785411d7f094d7d7c4','e52de7af90d025785411d7f094d7d7c4','postgres',ARRAY['PUBLIC','anon','authenticated','postgres','service_role']::text[],true),
  ('app_private.guard_income_expense_owned_payload()','18b3e1c11f3e698f1daf2cd082313448','18b3e1c11f3e698f1daf2cd082313448','postgres',ARRAY['PUBLIC','postgres']::text[],true),
  ...
  ('app_private.finance_v2_post_manual_voucher(income_expenses,uuid,uuid,uuid,date,uuid[],text)','c2d88ccaae0d8c8a0d425ac4d6cd7f7f','528e457cc02ddcec3c0cd2c67044ae09','postgres',ARRAY['PUBLIC','postgres']::text[],true),
