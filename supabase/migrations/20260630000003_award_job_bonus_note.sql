-- =============================================
-- Migration: award_job_bonus tra them cot `note` = jobs.title (ghi chu cong viec)
--   de popup hien "noi dung cong viec" gop LOAI + GHI CHU, vd:
--   label="Sửa chữa" (loai) + note="vòi nước nhà tắm" (ghi chu) → "Sửa chữa · vòi nước nhà tắm".
--   Doi return signature → DROP truoc roi CREATE. Logic thuong GIU NGUYEN (20260630000001).
-- =============================================
