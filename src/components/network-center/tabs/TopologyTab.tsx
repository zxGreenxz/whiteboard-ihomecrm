...
export function TopologyTab({ site }: { site: NetworkBuilding }) {
  ...
  return (
    <div className="nc-tab-stack">
      ...
      <section className="nc-topology nc-topology-full" aria-labelledby="topology-title">
        ...
        <div className="nc-router-node"><Network /><strong>{site.router.identity}</strong><span>Gateway mô phỏng</span></div>
