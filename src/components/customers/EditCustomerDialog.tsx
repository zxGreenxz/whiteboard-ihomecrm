...
export function EditCustomerDialog({
  ...
  const [customerType, setCustomerType] = useState<"INDIVIDUAL" | "ORGANIZATION">(
    customer.customer_type as "INDIVIDUAL" | "ORGANIZATION" || "INDIVIDUAL"
  );
  ...
  useEffect(() => {
    if (customer) {
      setCustomerType(customer.customer_type as "INDIVIDUAL" | "ORGANIZATION" || "INDIVIDUAL");
      form.reset({
        customer_type: customer.customer_type as any || "INDIVIDUAL",
        full_name: customer.full_name,
        phone: customer.phone || "",
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="flex justify-end gap-3 pt-4 border-t">
                ...
                <Button type="submit" disabled={updateCustomer.isPending} className="bg-green-600 hover:bg-green-700">
                  {updateCustomer.isPending ? "Đang cập nhật..." : "Lưu"}
                </Button>
              </div>
            </form>
          </Form>
