...
const customer: CT01Customer = {
  ...
  id_issue_date: '2022-02-25', id_issue_place: 'Cục Cảnh sát', permanent_address: 'Ấp Kiểm Thử, Xã Bình Mỹ',
};
...
describe('CT01 theo mẫu người dùng', () => {
  ...
  it('xuất DOCX thực từ mẫu: đúng các ô số, bốn ngày ký, không còn placeholder', async () => {
    ...
    const blob = await renderCT01Document(customer, building, lease, new Date('2026-09-13T18:01:00Z'));
