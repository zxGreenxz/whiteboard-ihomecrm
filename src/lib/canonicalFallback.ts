...
// legacy CHỈ khi tín hiệu hợp lệ (writer chưa deploy / rollout OFF). Mẫu rút từ
// paymentRecordRpc.ts, dùng chung cho cashbook/meter/… .
 ...
 * 42501 KHÔNG còn là tín hiệu fallback (plan §8, caller drain): đó là từ chối
 * quyền THẬT — phải fail và hiển thị lỗi, không được rơi về raw DML/legacy.
