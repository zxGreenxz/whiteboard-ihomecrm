...
export const KHOA_ROLLOUT_THANH_VIEN_VAI_TRO = 'copilot.members-roles.directory';
...
export const COPILOT_ROLLOUT_DOC_RIENG: readonly CopilotRolloutContract[] = [
  ...
  {
    scope: 'page',
    contractId: KHOA_ROLLOUT_THANH_VIEN_VAI_TRO,
    label: 'Danh sách thành viên và mẫu vai trò (Copilot đọc)',
  },
  {
    scope: 'page',
    contractId: KHOA_ROLLOUT_KHO_TAI_SAN,
    label: 'Danh sách kho tài sản (Copilot đọc)',
  },
  {
    scope: 'page',
    contractId: KHOA_ROLLOUT_NHA_CUNG_CAP,
    label: 'Danh sách nhà cung cấp (Copilot đọc)',
  },
  {
    scope: 'page',
  ...
  {
    scope: 'page',
    contractId: KHOA_ROLLOUT_DANH_SACH_TANG,
    label: 'Danh sách tầng (Copilot đọc)',
  },
  {
    scope: 'page',
