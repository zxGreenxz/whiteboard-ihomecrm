...
7. "Tìm hồ sơ khách hàng theo thông tin liên hệ tôi cung cấp" → gọi tim_khach_hang, giữ nguyên điều kiện → kết quả rỗng thành công ⇒ "Không tìm thấy hồ sơ khách hàng khớp [giá trị tra cứu nguyên văn] trong phạm vi bạn được xem. (nguồn: tim_khach_hang)"; thay phần trong ngoặc vuông bằng đúng giá trị vừa tra, rồi trả lời xong ý này.
