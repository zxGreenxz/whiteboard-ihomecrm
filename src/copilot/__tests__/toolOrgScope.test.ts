...
const TOOL_THEO_CONG_TY = [
  ...
  { ten: 'danh_sach_khu_vuc', args: { so_luong: 20 } },
  { ten: 'danh_sach_cong_to', args: { so_luong: 20 } },
  { ten: 'thong_bao_gan_day', args: { so_luong: 20 } },
  { ten: 'danh_sach_phong_sale', args: { so_luong: 20 } },
  { ten: 'danh_sach_thanh_vien_vai_tro', args: { so_luong: 20 } },
  { ten: 'danh_sach_kho_tai_san', args: { so_luong: 20 } },
  { ten: 'danh_sach_nha_cung_cap', args: { so_luong: 20 } },
  { ten: 'danh_sach_loai_tai_san', args: { so_luong: 20 } },
  { ten: 'danh_sach_loai_cong_viec', args: { so_luong: 20 } },
  { ten: 'danh_sach_tang', args: { so_luong: 20 } },
  { ten: 'danh_sach_hotline', args: { so_luong: 20 } },
  { ten: 'danh_sach_dinh_muc_dich_vu', args: { so_luong: 20 } },
  { ten: 'danh_sach_toa_nha', args: { so_luong: 20 } },
  { ten: 'trang_thai_gach_no_tu_dong', args: { so_luong: 20 } },
  { ten: 'danh_sach_bao_tri_tai_san', args: { so_luong: 20 } },
  { ten: 'danh_sach_tai_san', args: { so_luong: 20 } },
  { ten: 'danh_sach_dich_vu', args: { so_luong: 20 } },
  ...
  { ten: 'bao_cao_khuyen_mai', args: { so_luong: 20 } },
  { ten: 'bao_cao_ban_giao', args: { so_luong: 20 } },
  { ten: 'bao_cao_chu_ky_thu', args: { so_luong: 20 } },
  ...
  {
    ten: 'ghi_chu_phieu_thu_chi',
    args: { voucher_id: 'aaaa4000-0000-4000-8000-000000000021', notes: 'ghi chú mới' },
  },
  {
    ten: 'dat_han_giu_cho',
    args: { income_expense_id: 'aaaa4000-0000-4000-8000-000000000022', hold_until: '2026-10-01' },
  },
  {
