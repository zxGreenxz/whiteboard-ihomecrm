...
export default function CustomerDebtReport() {
  ...
  const [buildingIds, setBuildingIds] = usePersistedState<string[]>("flt:rpt-customer-debt:buildingIds", []);
  const [roomId, setRoomId] = usePersistedState<string>("flt:rpt-customer-debt:roomId", "all");
