...
const InvoicesPage = () => {
  ...
  // Data fetching
  const { data: invoicesData, isLoading } = useInvoices(filters, { page, pageSize });
  ...
  // Placeholder handlers for features to be implemented in later tasks
  ...
  return (
    ...
    >
      ...
      <InvoiceListToolbar
        ...
        onBulkDownloadImages={handleBulkDownloadImages}
