...
const TerminationApprovalsPage = () => {
  ...
  return (
    <MainLayout
      title="Duyệt thanh lý hợp đồng"
      subtitle={`${pendingCount} yêu cầu đang chờ xử lý`}
      icon={ClipboardCheck}
    >
      <Card>
        <CardHeader>
                ...
                <CardContent className="pt-4 space-y-3">
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <div className="text-gray-500">Khách thuê</div>
...
export default TerminationApprovalsPage;
