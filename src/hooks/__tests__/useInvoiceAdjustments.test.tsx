...
it('invalidates current documents, collection views and financial projections after adjustment', async () => {
  ...
  const keys = ['invoices', 'invoices-legacy', 'invoice', 'invoice-statistics', 'excess-amount', 'invoice-totals-by-ids', 'first-invoice-details', 'invoice-rent-periods', 'business-performance', 'invoice-rounding-report', 'invoice-payments-summary', 'financial-analysis', 'collection-cycle', 'finance-v2-routes'];
