...
import type { RenewalTransferRow, VacantRoomNote } from "./types";
...
// (useOccupancyReport/useOccupancyTrend đã thay bằng RPC server-side —
//  xem src/hooks/reports/useOccupancyDashboard.ts, Phase 8)
