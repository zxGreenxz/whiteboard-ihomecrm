...
export interface ContractFixture {
  ...
  searchPayload: unknown; detailPayload?: unknown;
}
export function contractQuery(caseId: string, contextId: string, listingPayload?: unknown): string;
export function bindContractScenario(scenario: GoldenScenario, input: { query: string; searchPayload: unknown; detailPayload?: unknown }): ContractFixture;
