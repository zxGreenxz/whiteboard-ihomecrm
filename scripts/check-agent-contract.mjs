...
const CONTRACT_INVARIANTS = [
    ...
    ['cccc0000', 'org TEST cũ đã xoá — sandbox_org_ids() còn trả id này'],
    ['clone-org', 'cơ chế org TEST cũ đã gỡ — đừng dựng lại org sao chép trong database production'],
    ['test-env:sync', 'đồng bộ môi trường TEST (project Supabase riêng)'],
