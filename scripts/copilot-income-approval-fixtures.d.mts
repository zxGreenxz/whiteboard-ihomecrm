...
export function bindIncomeApprovalScenario(scenario:GoldenScenario,input:{request:IncomeApprovalRequest;payload:unknown;actorDigest:string}):IncomeApprovalFixture;
