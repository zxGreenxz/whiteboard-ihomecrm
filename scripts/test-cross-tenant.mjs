...
-- lý do không liên quan tới cách ly tenant. Ma trận này không có ca nào POLL
-- bằng worker fixture (chỉ inventory_v2), nên false là đúng nhu cầu thật.
...
SELECT worker.id, fixture.demo_organization_id, input.building_id,
       input.device_id, 'MIKROTIK', false, true, false,
       clock_timestamp() - INTERVAL '1 minute'
FROM _nc_fixture fixture
